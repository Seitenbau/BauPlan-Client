# Contributing to BauPlan-Client

Love BauPlan-Client and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/Seitenbau/BauPlan-Client/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/BauPlan-Client.git
   # Navigate to the newly cloned directory
   cd Bauplan
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/Seitenbau/BauPlan-Client.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/Seitenbau/BauPlan-Client/blob/master/LICENSE.md).
